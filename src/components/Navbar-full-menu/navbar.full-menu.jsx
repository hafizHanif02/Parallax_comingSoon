                          ...
                          <div className="o-hidden">
                            <Link href={`/showcase/showcase-dark`}>
                              <a className="sub-link">
                                <span className="nm">01.</span>Portfolio 1
                              </a>
                            </Link>
                          </div>
                        </li>
                        <li>
                          <div className="o-hidden">
                            <Link href={`/showcase4/showcase4-dark`}>
                              <a className="sub-link">
                                <span className="nm">02.</span>Portfolio 2
                              </a>
                            </Link>
                          </div>
                        </li>
                        <li>
                          <div className="o-hidden">
                            <Link href={`/showcase3/showcase3-dark`}>
                              <a className="sub-link">
                                <span className="nm">03.</span>Portfolio 3
                              </a>
                            </Link>
                          </div>
                        </li>
                        <li>
                          <div className="o-hidden">
                            <Link href={`/works/works-dark`}>
                              <a className="sub-link">
                                <span className="nm">04.</span>Portfolio 4
                              </a>
                            </Link>
                          </div>
                        </li>
                        <li>
                          <div className="o-hidden">
                            <Link href={`/works2/works2-dark`}>
                              <a className="sub-link">
                                <span className="nm">05.</span>Portfolio 5
                        ...
                        <li>
                          <div className="o-hidden">
                            <Link href={`/works3/works3-dark`}>
                              <a className="sub-link">
                                <span className="nm">06.</span>Portfolio 6
                              </a>
                            </Link>
                          </div>
                        </li>
